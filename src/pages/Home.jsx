      ...
      <div className="bg-black text-white">
        <div className="flex flex-col md:flex-row items-center md:items-stretch gap-6 px-6 md:px-20 py-16 border-b border-gray-700">
          <div className="md:w-1/2 w-full flex flex-col justify-center space-y-6 max-w-lg">
            ...
            <button className="w-40 py-2 border bg-[rgb(11,59,95)] rounded-full font-semibold hover:bg-white hover:text-black transition">
              VISIT SUPPORT
            </button>
          </div>
          <div className="md:w-1/2 w-full flex justify-center md:justify-end items-center space-x-4">
            <img
              src="/image.png"
              alt="Crash Bandicoot"
              className="w-20 sm:w-28 md:w-40 object-contain bg-cover"
            />
            <img
              src="/image-copy.png"
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-stretch gap-6 px-4 sm:px-10 md:px-20 py-12 sm:py-16 bg-black">
          ...
          <div className="relative w-full max-w-full h-48 md:h-64 lg:h-72 overflow-hidden bg-black">
            <img
              src="\public\snak.png"
              className="absolute inset-0 w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-opacity-40"></div>
            <div className="relative z-10 md:w-1/2 w-full max-w-lg text-white flex flex-col justify-center space-y-4 h-full px-6">
              <h2 className="font-bold text-3xl sm:text-4xl text-blue-700">
                HAVE FUN
              </h2>
          ...
          <div className="md:w-1/2 w-full flex flex-col sm:flex-row justify-between gap-8 sm:gap-10 text-white max-w-lg z-10">
            <ul className="space-y-2 sm:space-y-0 sm:space-x-6">
              <li>GAME DESIGN</li>
              <li>ART & ANIMATION</li>
